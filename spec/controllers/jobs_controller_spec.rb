...
describe JobsController do
  ...
  let(:valid_attributes) { { "github_id" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved job as @job" do
        ...
        post :create, {:job => { "github_id" => "invalid value" }}, valid_session
        assigns(:job).should be_a_new(Job)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested job" do
        ...
        Job.any_instance.should_receive(:update_attributes).with({ "github_id" => "MyString" })
        put :update, {:id => job.to_param, :job => { "github_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the job as @job" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Job.any_instance.stub(:save).and_return(false)
        put :update, {:id => job.to_param, :job => { "github_id" => "invalid value" }}, valid_session
        assigns(:job).should eq(job)
      end
